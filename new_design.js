  ...
  function init() {
    ...
    if (cardOuter && !document.querySelector('.plaan-tooltip-card')) {
      ...
      tooltip.innerHTML =
        ...
        '1. Нажмите кнопку «Восстановить пароль».<br>' +
        '2. Введите почту, которую указывали при записи на обучение.<br>' +
        '3. Подтвердите отправку — мы пришлём письмо с доступом.<br>' +
        '4. Откройте письмо и перейдите по ссылке.<br>' +
        '5. В личном кабинете зайдите в раздел «Профиль».<br>' +
